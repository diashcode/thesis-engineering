...
<header class="header">
    ...
    <nav class="navbar navbar-expand-lg fixed-top shadow navbar-light bg-white">
        <div class="container-fluid">
            <div class="d-flex align-items-center"><a href="<c:url value='/welcome'/>" class="navbar-brand py-1"><p>Taxi Service</p></p><!--<img src="img/logo.svg" alt="Directory logo">--></a>
            </div>
        ...
        <div class="row">
            <div class="col-xl-10">
                <div class="text-center text-lg-left">
                    ...
                    <h1 class="display-3 font-weight-bold text-shadow">I am going </h1>
                </div>
                <div class="search-bar mt-5 p-3 p-lg-1 pl-lg-4">
                    <form role = "form" method="post" action="/travel-search">
                        <div class="row">
...
<section class="hero-home">
    ...
    <div class="container py-6 py-md-7 text-white z-index-20">
        <div class="row">
            <div class="col-xl-10">
                <div class="text-center text-lg-left">
                    <h1 class="display-3 font-weight-bold text-shadow">I am looking for a taxi in  </h1>
                </div>
                <div class="search-bar mt-5 p-3 p-lg-1 pl-lg-4">
                    <form role = "form" method="post" action="/incity-taxi-search">
                        <div class="row">
...
<%--                </div>--%>
                <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
                    <ul class="list-unstyled">
                        <li><a href="#" target="_blank"  class="text-muted">Contact</a></li>
