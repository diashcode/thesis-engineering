...
<section class="py-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-7">
                <p class="subtitle text-primary">Your offered travels</p>
                <div class="text-block">
                </div>
                <div class="text-block">
                    <div class="row mb-3">
                        <div class="col-lg-8 pl-xl-5">
                            <c:forEach items="${userTravelList}" var="travel">
                                        ...
                                        <div class="card-body p-4">
                                            <div class="text-block pb-3">
                                                <div class="media align-items-center">
                                                    <div class="media-body">
                                                        <h6> <a href="detail-rooms.html" class="text-reset">Travels offered</a></h6>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="text-block py-3">
                                                <ul class="list-unstyled mb-0">
                                                    <li class="mb-3">${travel.travelDate}</li>
                                                    <li class="mb-0">${travel.pickup} <i class="fas fa-arrow-right fa-fw text-muted mx-3"></i>${travel.destination}</li>
                                                </ul>
                                            </div>
                                            <div class="text-block pt-3 pb-0">
                                                <table class="w-100">
                                                    <tbody>
                                                    <tr>
                                                        <th class="font-weight-normal py-2">Number of  seats</th>
                                                        <td class="text-right py-2">${travel.seats}</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="font-weight-normal pt-2 pb-3">Price</th>
                                                        <td class="text-right pt-2 pb-3">${travel.price}</td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </div>
