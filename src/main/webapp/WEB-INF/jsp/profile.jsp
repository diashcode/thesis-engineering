        ...
        <div class="container-fluid">
            ...
            <div id="navbarCollapse" class="collapse navbar-collapse">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown ml-lg-3"><a id="userDropdownMenuLink" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img src="img/avatar/avatar-10.jpg" alt="Jack London" class="avatar avatar-sm avatar-border-white mr-2"></a>
                        <div aria-labelledby="userDropdownMenuLink" class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-divider"></div><a href="<c:url value='/welcome'/>" class="dropdown-item"><i class="fas fa-sign-out-alt mr-2 text-muted"></i> Sign out</a>
                        </div>
                    </li>
                </ul>
            </div>
